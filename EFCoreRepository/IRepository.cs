...
namespace EFCoreRepository
{
    ...
    public interface IRepository : IDisposable
    {
        ...
        /// <param name="selector">选择指定列</param>
        /// <returns>返回集合</returns>
        IQueryable<S> Queryable<T, S>(Expression<Func<T, S>> selector) where T : class;
        ...
        /// <returns>返回集合</returns>
        IQueryable<T> Queryable<T>(Expression<Func<T, bool>> predicate, Expression<Func<T, object>> orderField, params OrderType[] orderTypes) where T : class;
        ...
        /// <param name="predicate">条件</param>
        /// <returns>返回集合</returns>
        IQueryable<S> Queryable<T, S>(Expression<Func<T, S>> selector, Expression<Func<T, bool>> predicate) where T : class;
        ...
        /// <param name="orderTypes">排序类型，默认正序排序</param>
        /// <returns>返回集合</returns>
        IQueryable<S> Queryable<T, S>(Expression<Func<T, S>> selector, Expression<Func<T, bool>> predicate, Expression<Func<T, object>> orderField, params OrderType[] orderTypes) where T : class;
        #endregion
        ...
        /// <param name="selector">选择指定列</param>
        /// <returns>返回集合</returns>
        Task<IQueryable<S>> QueryableAsync<T, S>(Expression<Func<T, S>> selector) where T : class;
        ...
        /// <param name="orderTypes">排序类型，默认正序排序</param>
        /// <returns>返回集合</returns>
        Task<IQueryable<T>> QueryableAsync<T>(Expression<Func<T, bool>> predicate, Expression<Func<T, object>> orderField, params OrderType[] orderTypes) where T : class;
        ...
        /// <param name="predicate">条件</param>
        /// <returns>返回集合</returns>
        Task<IQueryable<S>> QueryableAsync<T, S>(Expression<Func<T, S>> selector, Expression<Func<T, bool>> predicate) where T : class;
        ...
        /// <param name="orderTypes">排序类型，默认正序排序</param>
        /// <returns>返回集合</returns>
        Task<IQueryable<S>> QueryableAsync<T, S>(Expression<Func<T, S>> selector, Expression<Func<T, bool>> predicate, Expression<Func<T, object>> orderField, params OrderType[] orderTypes) where T : class;
        #endregion
        #endregion
